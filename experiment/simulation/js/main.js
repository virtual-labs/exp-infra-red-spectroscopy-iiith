    ...
    a1.add({
      ...
      .add({
        update: function (anim) {
          ...
          document.getElementById("bottom").style.fill = "#b83dba";
        },
        opacity: 0,
      });
    document
...
async function movePipette() {
  if (overallIteration === 2) {
    ...
    a1.add({
      ...
      .add({
        update: function (anim) {
          document.getElementById("top").style.fill = "#00a8f3";
        },
        opacity: 0,
      });
...
function createGraph() {
  ...
  yValues = [
    ...
    0.9432, 0.943, 0.9424, 0.9411, 0.939, 0.9361, 0.9327, 0.929, 0.9252, 0.9192,
    0.9113, 0.9039, 0.8973, 0.8907, 0.8853, 0.8806, 0.8759, 0.8713, 0.8667,
    0.8624, 0.8581, 0.8538, 0.8494, 0.8451, 0.8403, 0.8355, 0.8307, 0.8259,
    0.8205, 0.8146, 0.8087, 0.8017, 0.7945, 0.7871, 0.7798, 0.7725, 0.7651,
    0.7576, 0.7503, 0.7428, 0.7355, 0.7278, 0.7204, 0.7128, 0.7054, 0.6978,
    0.6901, 0.6825, 0.6749, 0.6671, 0.6595, 0.6518, 0.6441, 0.6362, 0.6285,
    0.6206, 0.6129, 0.6049, 0.597, 0.5891, 0.5812, 0.5732, 0.5652, 0.5572,
    0.5491, 0.541, 0.5329, 0.5248, 0.5167, 0.5085, 0.501, 0.4957, 0.4905,
    0.4862, 0.4819, 0.4776, 0.4737, 0.4706, 0.466, 0.4623, 0.4604, 0.4591,
    0.4585, 0.458, 0.4576, 0.4575, 0.4574, 0.4567, 0.4554, 0.4541, 0.4533,
    0.4528, 0.4531, 0.4545, 0.4576, 0.4617, 0.4649, 0.4665, 0.4669, 0.4673,
    0.4675, 0.4676, 0.4677, 0.4674, 0.4662, 0.4647, 0.463, 0.4615, 0.4601,
    0.4587, 0.4574, 0.4566, 0.4562, 0.456, 0.4568, 0.4575, 0.4582, 0.459,
    0.4595, 0.4601, 0.4616, 0.466, 0.472, 0.4787, 0.4862, 0.4953, 0.5049,
    0.5166, 0.5252, 0.5324, 0.5386, 0.5441, 0.5494, 0.5547, 0.5601, 0.5659,
    0.568, 0.5688, 0.5692, 0.5691, 0.5662, 0.5614, 0.5548, 0.5467, 0.5339,
    0.5246, 0.5202, 0.518, 0.5166, 0.5154, 0.5148, 0.5141, 0.5137, 0.5138,
    0.5142, 0.52, 0.5285, 0.5347, 0.5397, 0.5431, 0.5453, 0.5464, 0.5469,
    0.5465, 0.5429, 0.538, 0.5335, 0.5299, 0.5285, 0.5283, 0.5302, 0.5312,
    0.5317, 0.5322, 0.5321, 0.5319, 0.5333, 0.5365, 0.5453, 0.554, 0.5625,
    0.5705, 0.5784, 0.5849, 0.591, 0.5972, 0.6034, 0.6112, 0.6192, 0.6273,
    0.6349, 0.6425, 0.65, 0.6575, 0.6649, 0.6722, 0.6797, 0.6872, 0.6934,
    0.6987, 0.7031, 0.7069, 0.7108, 0.714, 0.7171, 0.72, 0.7228, 0.7249, 0.7261,
    0.7275, 0.7286, 0.7295, 0.7304, 0.7314, 0.7325, 0.7336, 0.7357, 0.7431,
    0.7517, 0.7591, 0.7656, 0.7719, 0.7778, 0.7836, 0.7897, 0.7964, 0.8024,
    0.8064, 0.8105, 0.8144, 0.8181, 0.8218, 0.8245, 0.8271, 0.8293, 0.8313,
    0.8332, 0.8352, 0.8365, 0.8375, 0.8388, 0.8399, 0.841, 0.842, 0.8436, 0.846,
    0.8485, 0.8514, 0.8546, 0.8589, 0.8631, 0.8657, 0.8654, 0.8646, 0.8635,
    0.863, 0.8635, 0.8665, 0.8687, 0.869, 0.8688, 0.8659, 0.8607, 0.8581,
    0.8568, 0.856, 0.8555, 0.8553, 0.8551, 0.8549, 0.8545, 0.8541, 0.8537,
    0.8535, 0.8533, 0.8531, 0.8531, 0.8536, 0.8563, 0.8628, 0.8648, 0.8633,
    0.8591, 0.8582, 0.8631, 0.8662, 0.8662, 0.8585, 0.8493, 0.8441, 0.8434,
    0.8474, 0.8509, 0.851, 0.8504, 0.8504, 0.8506, 0.8508, 0.8509, 0.851, 0.851,
    0.851, 0.8495, 0.8401, 0.8332, 0.8283, 0.8257, 0.8243, 0.823, 0.8141,
    0.7945, 0.7795, 0.7742, 0.7726, 0.7703, 0.7645, 0.761, 0.761, 0.7599,
    0.7483, 0.7154, 0.6851, 0.6628, 0.6444, 0.623, 0.5521, 0.4493, 0.3459,
    0.2421, 0.1849, 0.1283, 0.1188, 0.2162, 0.3246, 0.4336, 0.531, 0.533,
    0.5046, 0.426, 0.3473, 0.2678, 0.1879, 0.1077, 0.0646, 0.0638, 0.075,
    0.1203, 0.2332, 0.35, 0.4678, 0.5087, 0.5405, 0.5823, 0.6243, 0.6665,
    0.6989, 0.7128, 0.718, 0.6042, 0.4123, 0.2216, 0.2766, 0.4662, 0.6515,
    0.6954, 0.6895, 0.6601, 0.6691, 0.7208, 0.7318, 0.7632, 0.7942, 0.81,
    0.8124, 0.8254, 0.8328, 0.8349, 0.8328, 0.828, 0.8239, 0.8274, 0.8338,
    0.8278, 0.7262, 0.5509, 0.585, 0.6711, 0.6882, 0.4887, 0.2768, 0.2334,
    0.354, 0.5522, 0.5656, 0.5486, 0.5334, 0.5284, 0.4286, 0.3927, 0.4276,
    0.5092, 0.5681, 0.6275, 0.6786, 0.6772, 0.5844, 0.4909, 0.3966, 0.3959,
    0.5014, 0.6662, 0.7164, 0.7315, 0.7228, 0.6826, 0.6198, 0.5428, 0.4524,
    0.3239, 0.212, 0.1016, 0.0871, 0.1199, 0.1584, 0.1939, 0.2392, 0.3194,
    0.4022, 0.4304, 0.5367, 0.5207, 0.5019, 0.6134, 0.6253, 0.6208, 0.5674,
    0.4262, 0.2453, 0.1592, 0.2105, 0.2533, 0.2791,
  ];
  let arr = [];
