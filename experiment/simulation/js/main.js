...
function select(valu)
{
    ...
    // 
    // console.log(a)
    console.log("inside button function valu=",valu)
    buttonselectflag = 1
    buttoninfo = valu
    if (clickflag == 0)
    {
        ...
        clickflag = 1
        index = 0
        document.getElementById('message').innerHTML = messagearr[index];
        
    }
}
function movespatula()
{
    if (buttonselectflag==1)
    {
    if (spatulaflag==0)
    {
    console.log("inside function")
    var a0 = anime.timeline({
        targets: document.getElementById('spatulacontent2'),
        // opacity:'0.5',
        duration: 1200, 
        easing: 'linear',
    })
    var a1 = anime.timeline({
    targets: [document.getElementById('spatula'),document.getElementById('spatulacontent2')],
    // opacity:'0.5',
    duration: 1200, 
    easing: 'linear',
})
...
a1.add({
    ...
    update: function(anim) {
        index = 1
        sampleflag = 1
        console.log("indexhere is",index)
        document.getElementById("message").innerHTML = messagearr[index];
    }   
});
    }
...
{
    console.log("nizolflag=",nizolflag)
    if (nizolflag === 1)
    {
        var a7 = anime.timeline({
            targets: document.getElementById('waterdrop1'),
            // opacity:'0.5',
            duration: 1200, 
            easing: 'linear',
        })
...
var a3 = anime.timeline({
    targets: document.getElementById('dropperwater2'),
    //duration: 1200, 
    easing: 'linear',
})
a3.add({
...
function movemixer()
{
    ...
    {
        console.log("nizolflag3")
        var a5 = anime.timeline({
            targets: [document.getElementById('irplate'),document.getElementById('irplateheading')],
            // opacity:'0.5',
            duration: 1200, 
            easing: 'linear',
        }) 
        var a0 = anime.timeline({
            targets: document.getElementById('spatulacontent1'),
            // opacity:'0.5',
            duration: 1200, 
            easing: 'linear',
        })
        var a1 = anime.timeline({
            targets: [document.getElementById('spatula2'),document.getElementById('spatulacontent1')],
            // opacity:'0.5',
            duration: 1200, 
            easing: 'linear',
        })
...
{
    // var a0 = anime.timeline({
    //     targets: document.getElementById('irplate'),
    //     // opacity:'0.5',
    //     duration: 1200, 
    //     easing: 'linear',
    // })
...
function circles()
{
    ...
    a3.add({
        ...
        update: function(anim) {
            document.getElementById("message").innerHTML = messagearr[8];
        }
    })
    circleflag = 2
    startflag = 1
...
function redirect(){
    ...
    var url = './evalutation/evaluation.html'
    window.location(url);
}

function testlineanim()
{
    ...
    var a9 = anime.timeline({
        targets: document.getElementById('downarrow2'),
    ...
    var a8 = anime.timeline({
        targets: [document.getElementById('rightarrow2'),document.getElementById('uparrow1'),document.getElementById('downarrow1'),document.getElementById('leftarrow1')],
        // width: '10vw', // -> from '28px' to '100%',
        // easing: 'easeInOutQuad',left
        easing: 'linear',
        // direction: 'alternate',
        // translateX: '10vw',
        // loop: true
    ...
    var a7 = anime.timeline({
        targets: document.getElementById('rightarrow1'),
        // width: '10vw', // -> from '28px' to '100%',
        // easing: 'easeInOutQuad',
        easing: 'linear',
        // direction: 'alternate',
    ...
    var a6 = anime.timeline({
        targets: document.getElementById('linedownfinal'),
        // width: '10vw', // -> from '28px' to '100%',
        // easing: 'easeInOutQuad',
        easing: 'linear',
        // direction: 'alternate',
    ...
    var a5 = anime.timeline({
        targets: document.getElementById('linedown'),
        // width: '10vw', // -> from '28px' to '100%',
        // easing: 'easeInOutQuad',
        easing: 'linear',
        // direction: 'alternate',
    ...
    var a4 = anime.timeline({
        targets: document.getElementById('lineleft'),
        // width: '10vw', // -> from '28px' to '100%',
        // easing: 'easeInOutQuad',
        easing: 'linear',
        // direction: 'alternate',
    ...
    var a3 = anime.timeline({
        targets: document.getElementById('lineup'),
        // width: '10vw', // -> from '28px' to '100%',
        // easing: 'easeInOutQuad',
        easing: 'linear',
        // direction: 'alternate',
    ...
    var a2 = anime.timeline({
        targets: document.getElementById('lineright'),
        // width: '10vw', // -> from '28px' to '100%',
        // easing: 'easeInOutQuad',
        easing: 'linear',
        // direction: 'alternate',
    ...
    var a1 = anime.timeline({
        targets: document.getElementById('line'),
        // width: '10vw', // -> from '28px' to '100%',
        // easing: 'easeInOutQuad',
        easing: 'linear',
        // direction: 'alternate',
