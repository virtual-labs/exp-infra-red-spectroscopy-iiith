...
function movemixer() {
    ...
    if (startanimflag == 2) {
        ...
        let lay1 = anime.timeline({
            targets: document.getElementById('layer1'),
            duration: 1200,
            easing: 'linear',
        })
        let lay2 = anime.timeline({
...
function changelayerthree() {
    console.log("startanimflag is", startanimflag)
    if (startanimflag == 10) {
        let var1 = anime.timeline({
            targets: document.getElementById('layer3'),
            duration: 1200,
            easing: 'linear',
        })
        let var2 = anime.timeline({
    ...
    let lay5 = anime.timeline({
        ...
        update: function (anim) {
            if (startanimflag == 12) {
                creategraph()
                startanimflag = 13
                console.log("check = ", startanimflag)
            }
...
function creategraph() {
    ...
    console.log("inside create graph ", startanimflag)
    if (graphflag == 0) {
        console.log("here")
        var a22 = anime.timeline({
