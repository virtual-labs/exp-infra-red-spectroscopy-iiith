   ...
   # def updatepadl(self,arr):
    ...
    def __printscreen(self,vis,idarr,getarr):
        ...
        for i in range(150):
            tempo+=" "
        print(' ')
        print("YOUR SCORE IS", self.__scr,"  TIME ACTIVE:",int(time.time()-self.__timeplayed),"s"," Lives Remaining:",self.__liferemain," LEVEL:",self.__level)
